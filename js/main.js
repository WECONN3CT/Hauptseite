...
(function() {
    ...
    // ================================
    // GitHub-Style Glow Container Scroll Animation
    // Kasten kommt beim Scrollen hoch über die Hero-Section
    // ================================
    function initGithubScrollAnimation() {
        const container = document.getElementById('github-glow-container');
        const section = document.getElementById('github-glow-section');
    ...
    function initMockupCarousel() {
        ...
        function next() {
            ...
            const activeTab = document.querySelector('.github-tab.active');
    ...
    // ================================
    // GitHub-Style Feature Tabs
    // ================================
    function initGithubTabs() {
        const tabsContainer = document.querySelector('.github-tabs');
        ...
        const activeTab = tabsContainer.querySelector('.github-tab.active');
        if (activeTab) {
            moveBlob(activeTab);
        }
        ...
        window.addEventListener('resize', () => {
            const current = tabsContainer.querySelector('.github-tab.active');
    ...
    function initCaseStudySlideshow() {
        const slideshowContainer = document.getElementById('caseStudySlideshow');
        ...
        console.log('Case Study Slideshow initialized with', slides.length, 'slides');
    }
